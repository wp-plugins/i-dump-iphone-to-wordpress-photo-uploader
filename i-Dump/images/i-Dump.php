...
?>
<h2>i-Dump Upload Settings for <?php echo get_option('idump_username'); ?> & <?php echo get_option('idump_username1'); ?><span class="style2"><a href="http://www.i-dump.info" target="_blank"><img src="../wp-content/plugins/i-Dump/images/i-dump-logo-backoffice.jpg" alt="i-Dump iPhone to Wordpress app " border="0" align="right" /></a></span></h2>
...
echo"</tr></table></style></center><br> </form><br><center><small>Images will <b>not</b> be destroyed but available in the files folder of your i-Dump plugin folder. Thank you for using <a href='http://www.i-dump.info/'>i-Dump</a>. </center></small><hr>";
