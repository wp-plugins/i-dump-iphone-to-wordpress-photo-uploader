...
$path = $blog_url . "/wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/files";
$path1 = $blog_url . "/wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader";
$path2 = $blog_url . "/wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/files/thumb";
$glimit = get_option('idump_glimit');
$gcols = get_option('idump_gcols');
$gtext = get_option('idump_gtext');

if ($glimit == '' || $gcols == ''){
   $gtext ='<img src="../wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/images/sign_warning.png"><b><font color=red> Please set your limits and photos per row at your i-Dump management <br> as well make sure you uploaded at least 1 photo.</font></b>';
   $glimit = 0;
   $gcols = 0;
}
$gcols = $gcols +1;
...
$folder = '../wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/files';
if (is_writable($folder)) {
    echo 'Your domain url of the WP-Dump iPhone app : <b>',$blog_urlrepl,'</b>';// folder is correct
} else {
    echo '<img src="../wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/images/sign_warning.png"><small> Folders i-Dump/<b>files & thumbs</b> need cmod 777, please adjust it for personal usage.</small><img src="../wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/images/sign_warning.png">';
}
...
<h2>Manage your uploaded images</h2>
        ...
        $count = mysql_num_rows($sqlcount);
		    $path="../wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/files";
...
//<input type=\"image\" src=\"$blog_url/wp-content/plugins/i-Dump/images/delete.png\" value=\"$record->id\" name=\"delete\">
    ...
    echo "<td><img src=\"$path2/$filesql\" alt=\"$time\" /><input type=\"image\" src=\"$blog_url/wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/images/delete.png\" value=\"$record->id\" name=\"delete\">
