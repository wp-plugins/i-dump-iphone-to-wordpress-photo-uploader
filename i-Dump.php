...
if (!is_dir('../wp-content/uploads/i-dump-uploads')) {
    mkdir('../wp-content/uploads/i-dump-uploads');
}

if (!is_dir('../wp-content/uploads/i-dump-uploads/thumbnails')) {
    mkdir('../wp-content/uploads/i-dump-uploads/thumbnails');
}

//mkdir('../wp-content/uploads/i-dump-uploads', 0777);
//mkdir('../wp-content/uploads/i-dump-uploads/thumbnails', 0777);
...
$folder = '../wp-content/uploads/i-dump-uploads';
 if(stristr($blog_url, 'http://www') === FALSE) {
    echo '<font color="red"><img src="../wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/images/sign_warning.png">Your domain should start with <b>http://www.</b>. Your version of WP-Dump will not work with this WordPress installation.<img src="../wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/images/sign_warning.png"></font>';
  } else{
...
<center><small>Images will <b>not</b> be destroyed but available in the files folder of your WordPress Upload folder. Thank you for using <a href='http://www.i-dump.info/'>i-Dump</a>. </center></small>";
