...
<a href="http://itunes.apple.com/us/app/wp-dump/id413231620?mt=8&ls=1"><img src="../wp-content/plugins/i-dump-iphone-to-wordpress-photo-uploader/images/i-dump-logo-backoffice.jpg" height="122" width="122" alt="i-Dump iPhone to Wordpress app " width="175" height="111" border="0" align="right" /></a>
...
if (is_writable($folder)) {
    echo ' &nbsp Your domain url of the WP-Dump iPhone app : <b>',$blog_urlrepl,'</b>';// folder is correct
} else {
